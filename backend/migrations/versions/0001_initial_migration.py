...
Revision ID: 0001
Revises: 
Create Date: 2024-10-25 17:58:33.371883
...
def upgrade() -> None:
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True, comment='Обновлена'),
    sa.Column('complete_before', sa.DateTime(timezone=True), nullable=True, comment='Выполнить до'),
    sa.Column('completed_at', sa.DateTime(timezone=True), nullable=True, comment='Выполнена'),
    sa.Column('id', sa.Uuid(), server_default=sa.text('gen_random_uuid()'), nullable=False, comment='Идентификатор'),
